...
const FilterableInsights = () => {
  ...
  const industries = [...new Set(insights.map((project) => project.industry))];
  const capabilities = [...new Set(insights.map((project) => project.capabilities))];
  const locations = [...new Set(insights.map((project) => project.location))];
  ...
  const filteredinsights = insights.filter((project) => {
    return (
